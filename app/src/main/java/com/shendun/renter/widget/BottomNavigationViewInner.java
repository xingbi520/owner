...
public class BottomNavigationViewInner extends BottomNavigationView {
    ...
    public BottomNavigationViewInner(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (!a.hasValue(
            styleable.BottomNavigationView_itemIconTint)) {
            clearIconTintColor();
        }
        a.recycle();
    }
    ...
    public BottomNavigationMenuView getBottomNavigationMenuView() {
        if (null == mMenuView){
            ...
            if (mMenuView != null) {
                mMenuView.setClipChildren(false);
            }
        }
        return mMenuView;
    }
     ...
     * necessary calls back to the provided {@link BottomNavigationViewInner} so that the tab
     * position is
     * kept in sync.
     * <p>
    ...
    private static class MyOnNavigationItemSelectedListener
        ...
        MyOnNavigationItemSelectedListener(
            ViewPager viewPager, BottomNavigationViewInner bnve,
    ...
    // * @param marginTop in px
    // */
    public BottomNavigationViewInner setIconBackground(int position, int background) {
        /*
        1. BottomNavigationItemView
        2. private final int mDefaultMargin;
         */
