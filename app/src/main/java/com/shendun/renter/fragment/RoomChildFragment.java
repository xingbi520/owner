...
public class RoomChildFragment extends BaseFragment<FragmentOrderRoomBinding> {
    ...
    public static RoomChildFragment newInstance(final String orderType) {
        RoomChildFragment fragment = new RoomChildFragment();
