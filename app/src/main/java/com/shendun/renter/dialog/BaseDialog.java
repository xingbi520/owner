...
public abstract class BaseDialog<T extends BaseDialog<T>> extends Dialog {
    ...
    /** the child_item of mLlControlHeight you create.(创建出来的mLlControlHeight的直接子View) */
    ...
    private long mAutoDismissDelay = 800;
...
//        setDialogTheme();
     ...
     * showSoft: 显示软件盘
     */
    public BaseDialog(Context context, int showSoft) {
...
//        setDialogTheme();
    ...
    private void setDialogTheme() {
        ...
        getWindow().addFlags(LayoutParams.SOFT_INPUT_STATE_ALWAYS_VISIBLE);
    }
