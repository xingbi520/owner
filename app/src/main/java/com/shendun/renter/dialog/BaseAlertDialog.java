...
public abstract class BaseAlertDialog<T extends BaseAlertDialog<T>> extends BaseDialog<T> {
    ...
    /** content text */
    protected SpannableString mSpannableString=null;
    /** contentView */
     ...
     * @param context
     */
    public BaseAlertDialog(Context context, boolean isShowSoft) {
        super(context,0);
        widthScale(0.73f);
    ...
    public void setUiBeforShow() {
        ...
        /** ContentView */
//        mContentView.setGravity(mContentGravity);
    ...
    /** set content text(设置正文内容) */
    public T content(SpannableString content) {
        mSpannableString = content;
        mContentView.setVisibility(View.GONE);
        return (T) this;
    }
