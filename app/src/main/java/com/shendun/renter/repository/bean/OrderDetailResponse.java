...
public class OrderDetailResponse implements Serializable {
    ...
    public String getG_is_patrol_error() {
        return g_is_patrol_error;
    }

    public void setG_is_patrol_error(String g_is_patrol_error) {
        this.g_is_patrol_error = g_is_patrol_error;
    }
