package com.shendun.topbar.widget;
...
import com.shendun.topbar.R;
import com.shendun.topbar.statusbar.StatusBarUtils;
import com.shendun.topbar.utils.ScreenUtils;
...
public class TopBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void loadAttributes(Context context, AttributeSet attrs) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            fillStatusBar = array.getBoolean(R.styleable.TopBar_fillStatusBar, false);
        }
        titleBarColor = array.getColor(R.styleable.TopBar_titleBarColor, Color.parseColor("#ffffff"));
        titleBarHeight = (int) array.getDimension(R.styleable.TopBar_titleBarHeight, ScreenUtils.dp2PxInt(context, 44));
        statusBarColor = array.getColor(R.styleable.TopBar_statusBarColor, Color.parseColor("#ffffff"));
        statusBarMode = array.getInt(R.styleable.TopBar_statusBarMode, 0);

        showBottomLine = array.getBoolean(R.styleable.TopBar_showBottomLine, true);
        bottomLineColor = array.getColor(R.styleable.TopBar_bottomLineColor, Color.parseColor("#dddddd"));
        bottomShadowHeight = array.getDimension(R.styleable.TopBar_bottomShadowHeight, ScreenUtils.dp2PxInt(context, 0));

        leftType = array.getInt(R.styleable.TopBar_leftType, TYPE_LEFT_NONE);
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            leftText = array.getString(R.styleable.TopBar_leftText);
            leftTextColor = array.getColor(R.styleable.TopBar_leftTextColor, getResources().getColor(R.color.comm_titlebar_text_selector));
            leftTextSize = array.getDimension(R.styleable.TopBar_leftTextSize, ScreenUtils.dp2PxInt(context, 16));
            leftDrawable = array.getResourceId(R.styleable.TopBar_leftDrawable, 0);
            leftDrawablePadding = array.getDimension(R.styleable.TopBar_leftDrawablePadding, 5);
        } else if (leftType == TYPE_LEFT_IMAGEBUTTON) {
            leftImageResource = array.getResourceId(R.styleable.TopBar_leftImageResource, R.drawable.comm_titlebar_reback_selector);
        } else if (leftType == TYPE_LEFT_CUSTOM_VIEW) {
            leftCustomViewRes = array.getResourceId(R.styleable.TopBar_leftCustomView, 0);
        }

        rightType = array.getInt(R.styleable.TopBar_rightType, TYPE_RIGHT_NONE);
        if (rightType == TYPE_RIGHT_TEXTVIEW) {
            rightText = array.getString(R.styleable.TopBar_rightText);
            rightTextColor = array.getColor(R.styleable.TopBar_rightTextColor, getResources().getColor(R.color.comm_titlebar_text_selector));
            rightTextSize = array.getDimension(R.styleable.TopBar_rightTextSize, ScreenUtils.dp2PxInt(context, 16));
        } else if (rightType == TYPE_RIGHT_IMAGEBUTTON) {
            rightImageResource = array.getResourceId(R.styleable.TopBar_rightImageResource, 0);
        } else if (rightType == TYPE_RIGHT_CUSTOM_VIEW) {
            rightCustomViewRes = array.getResourceId(R.styleable.TopBar_rightCustomView, 0);
        }

        centerType = array.getInt(R.styleable.TopBar_centerType, TYPE_CENTER_NONE);
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            centerText = array.getString(R.styleable.TopBar_centerText);
            centerTextColor = array.getColor(R.styleable.TopBar_centerTextColor, Color.parseColor("#333333"));
            centerTextSize = array.getDimension(R.styleable.TopBar_centerTextSize, ScreenUtils.dp2PxInt(context, 18));
            centerTextMarquee = array.getBoolean(R.styleable.TopBar_centerTextMarquee, true);
            centerSubText = array.getString(R.styleable.TopBar_centerSubText);
            centerSubTextColor = array.getColor(R.styleable.TopBar_centerSubTextColor, Color
                .parseColor("#666666"));
            centerSubTextSize = array.getDimension(R.styleable.TopBar_centerSubTextSize, ScreenUtils.dp2PxInt(context, 11));
        } else if (centerType == TYPE_CENTER_SEARCHVIEW) {
            centerSearchEditable = array.getBoolean(R.styleable.TopBar_centerSearchEditable, true);
            centerSearchBgResource = array.getResourceId(R.styleable.TopBar_centerSearchBg, R.drawable.comm_titlebar_search_gray_shape);
            centerSearchRightType = array.getInt(R.styleable.TopBar_centerSearchRightType, TYPE_CENTER_SEARCH_RIGHT_VOICE);
        } else if (centerType == TYPE_CENTER_CUSTOM_VIEW) {
            centerCustomViewRes = array.getResourceId(R.styleable.TopBar_centerCustomView, 0);
        }
    ...
    private void initGlobalViews(Context context) {
        ...
        rlMain.setId(R.id.smarthome_topbar);
