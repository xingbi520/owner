...
//                    int degrees = 0;
//                    if (pref != null) {
//                        degrees = pref.getInt("show_angel", 0);
//                    } else {
//                        Log.e("wensm", "pref == null ");
//                    }
...
//                    Bitmap outputBitmap = Bitmap.createBitmap(mCacheBitmap, 0, 0, mCacheBitmap.getWidth(), mCacheBitmap.getHeight(), matrix, true);
                ...
                canvas.drawBitmap(mCacheBitmap, new Rect(0,0,mCacheBitmap.getWidth(), mCacheBitmap.getHeight()),new Rect(0,0,canvas.getWidth(),canvas.getHeight()), paint);
//                canvas.drawBitmap(mCacheBitmap, new Rect(0,0,mCacheBitmap.getWidth(), mCacheBitmap.getHeight()),
//                        new Rect((canvas.getWidth() - mCacheBitmap.getWidth()) / 2,
//                                (canvas.getHeight() - mCacheBitmap.getHeight()) / 2,
//                                (canvas.getWidth() - mCacheBitmap.getWidth()) / 2 + mCacheBitmap.getWidth(),
...
////end
//
//                matrix.preTranslate((canvas.getWidth() - mCacheBitmap.getWidth()) / 1.7f,(canvas.getHeight() - mCacheBitmap.getHeight()) / 1.6f);
//                matrix.postRotate(90f,(canvas.getWidth()) / 2,(canvas.getHeight()) / 2);
//                float scale = (float) canvas.getWidth() / (float) mCacheBitmap.getHeight();
//                matrix.postScale(scale, scale, canvas.getWidth()/2 , canvas.getHeight()/2 );
//                canvas.drawBitmap(mCacheBitmap, matrix, new Paint());
